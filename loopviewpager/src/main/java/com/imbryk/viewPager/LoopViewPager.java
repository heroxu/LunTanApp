...
public class LoopViewPager extends ViewPager {
    ...
    private static final int DEFAULT_AUTO_SCROLL_INTERVAL = 4_000;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (Math.abs(ev.getX() - mDownX) > Math.abs(ev.getY() - mDownY) / 2) {
                    if (!mIsAutoScroll) return true;
                    getParent().requestDisallowInterceptTouchEvent(true);
                } else
    ...
    public void setOnPageChangeCallback(OnPageChangeListener listener) {
